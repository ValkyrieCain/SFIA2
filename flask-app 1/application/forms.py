...
class Objectclass(FlaskForm):
	...
	def validate_class(self, objectclass):
		if objectclass.objectclass.data.lower()!= "safe" and objectclass.objectclass.data.lower()!= "euclid" and
		 objectclass.objectclass.data.lower()!= "keter" and objectclass.objectclass.data.lower()!= "test":
